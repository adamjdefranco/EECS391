...
public class AstarAgent extends Agent{
    ...
    private boolean shouldReplanPath(State.StateView state, History.HistoryView history, Stack<MapLocation> currentPath) {
        //We need to see if the footman is in our path. If so return true.
        //Get the footman's current location
    ...
    private Stack<MapLocation> AstarSearch(MapLocation start, MapLocation goal, int xExtent, int yExtent, MapLocation enemyFootmanLoc, Set<MapLocation> resourceLocations) {
        ...
        PriorityQueue<MapLocation> queue = new PriorityQueue<>((o1, o2) -> {
            return Float.compare((o1.cost + chebyshevDistance(o1,goal)),(o2.cost + chebyshevDistance(o2,goal)));
        });
        ...
        do {
            ...
            for(MapLocation m : neighbours){
                ...
                if(m.equals(enemyFootmanLoc)){
                    continue;
                }
                if(resourceLocations.contains(m)){
    ...
    private float chebyshevDistance(MapLocation a, MapLocation b) {
